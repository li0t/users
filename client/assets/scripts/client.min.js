!function(ng) {
    ...
    "use strict";
    ng.module("App").controller("Entries:Detail", [ "$scope", "$http", "$location", "$session", function($scope, $http, $location, $session) {
        $scope.fetchingEntry = null, $scope.entry = null, $scope.fetch = function() {
            $scope.fetchingEntry = !0, $http.get("/api/entries/" + $routeParams.id).success(function(data) {
                $scope.entry = data;
            })["finally"](function() {
                $scope.fetchingEntry = !1;
            });
        }, $scope.fetch();
    } ]);
}(angular), function(ng) {
    ...
    ng.module("App").controller("Groups:Entries", [ "$scope", "$http", "$location", "$session", "$routeParams", function($scope, $http, $location, $session, $routeParams) {
        $scope.fetchingEntry = null, $scope.entry = null, $scope.fetch = function() {
            $scope.fetchingEntry = !0, $http.get("/api/entries/" + $routeParams.entry).success(function(data) {
                $scope.entry = data;
            })["finally"](function() {
                $scope.fetchingEntry = !1;
            });
    ...
    ng.module("App").controller("Groups:Profile", [ "$scope", "$http", "$location", "$session", "$routeParams", function($scope, $http, $location, $session, $routeParams) {
        ...
        $scope.entries = null, $scope.group = null, $scope.fetchGroup = function() {
            ...
            $scope.fetchingEntries = !0, $http.get("/api/groups/entries/" + $routeParams.id).success(function(data) {
                $scope.entries = data;
            })["finally"](function() {
    ...
    ng.module("App").controller("Groups:Tasks:Detail", [ "$scope", "$http", "$location", "$session", "$routeParams", function($scope, $http, $location, $session, $routeParams) {
        ...
        }, $scope.fetch(), $scope.close = function() {}, $scope.reOpen = function() {};
    } ]);
}(angular), function(ng) {
    "use strict";
